...
// PORTFOLIO MODE: Force login as admin
$_SESSION['user_id'] = 1;
$_SESSION['user_role'] = 'admin';
$_SESSION['user_name'] = 'Daniel Lawson';
...
function require_login() {
    return; // PORTFOLIO MODE: Bypass auth check
}
...
function status_label($status) { return get_status_label($status); }
